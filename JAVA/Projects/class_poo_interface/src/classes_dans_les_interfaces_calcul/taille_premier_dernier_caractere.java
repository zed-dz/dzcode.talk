...
public class taille_premier_dernier_caractere extends javax.swing.JFrame {

    public taille_premier_dernier_caractere() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Entrer la chaine de caractère : ");
...
a1.setText("le mot "+nom+" \n Sa taille est "+nom.length()+
     "\n son premier caractere est "
     +nom.charAt(0)+"\n son dernier caractere est "
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new taille_premier_dernier_caractere().setVisible(true);
            }
        });
    }
