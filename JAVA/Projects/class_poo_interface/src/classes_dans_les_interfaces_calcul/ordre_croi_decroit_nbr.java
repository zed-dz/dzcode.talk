...
public class ordre_croi_decroit_nbr extends javax.swing.JFrame {

 
    public ordre_croi_decroit_nbr() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Entrer un nombre");
        ...
        ac.setColumns(20);
        ac.setRows(5);
        jScrollPane1.setViewportView(ac);
        ...
        jLabel3.setText("Ordre croissant :");

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel4.setText("Ordre décroissant");
...
ad.append(i+"\n"); }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ordre_croi_decroit_nbr().setVisible(true);
            }
        });
    }
