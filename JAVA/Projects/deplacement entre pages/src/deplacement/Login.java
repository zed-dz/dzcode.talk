...
public class Login extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(t2, javax.swing.GroupLayout.DEFAULT_SIZE, 438, Short.MAX_VALUE)
                            .addComponent(t1)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(196, 196, 196)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(user.equals("admin") && mdp.equals("admin")){
            Accueil a=new Accueil(user,2);
            this.dispose();
            a.setVisible(true);
            //m++;
        }
        if(user.equals("agent") && mdp.equals("agent")){
            Accueil a=new Accueil(user, 1);
            this.dispose();
            a.setVisible(true);
           // m++;
        }
        if(user.equals("user") && mdp.equals("user")){
            Accueil a=new Accueil(user, 0);
            this.dispose();
            a.setVisible(true);
           // m++;
        } 
