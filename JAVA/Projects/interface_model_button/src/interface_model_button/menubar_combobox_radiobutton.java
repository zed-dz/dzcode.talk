...
public class menubar_combobox_radiobutton extends javax.swing.JFrame {
int a;
    public menubar_combobox_radiobutton() {
        initComponents();
    }
...
if(a==1){
    ...
    JOptionPane.showMessageDialog(null,"erreur","khata2",JOptionPane.ERROR_MESSAGE);
}
...
a=2;    }//GEN-LAST:event_jRadioButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed

ta.setText(c1.getSelectedItem().toString());  
// za3ma khayrt un elemnt mn combobox za3ma 5 alors tafichilk le 5 c tt
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(menubar_combobox_radiobutton.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new menubar_combobox_radiobutton().setVisible(true);
            }
        });
    }
