<?php
/*
Template Name: Slider Portfolio Grid Ajax
*/
...
if (!post_password_required()) {
    ...
    jQuery(window).load(function () {
        gt3_get_posts_grid_ajax("gt3_get_posts", "port", "' . $items_per_page . '", posts_already_showed, "portfolio_grid_ajax", "'.$selected_categories.'");
        posts_already_showed = posts_already_showed + ' . $items_per_page . ';
    });

    jQuery(".load_more_posts").click(function(){
        gt3_get_posts_grid_ajax("gt3_get_posts", "port", "' . $items_per_click . '", posts_already_showed, "portfolio_grid_ajax", "'.$selected_categories.'");
